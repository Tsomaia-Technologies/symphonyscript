...
import { SynapticBuilder } from '../../builder/src/SynapticBuilder'
...
export class SynapticClipBuilder {
     ...
     * @returns this for fluent chaining
     */
    play(target: SynapticClipBuilder, weight?: number, jitter?: number): this {
        this.builder.linkTo(target.getBuilder(), weight, jitter)
        return this
    }

    /**
     * Get the underlying SynapticBuilder instance.
     * 
     * @returns The wrapped SynapticBuilder
     */
    getBuilder(): SynapticBuilder {
        return this.builder
    }
