...
import type { ScaleContext } from '@symphonyscript/core/scales/types'
...
export interface ClipNode {
  readonly _version: import('@symphonyscript/core/schema/version').SchemaVersion
  kind: 'clip'
  name: string
  operations: ClipOperation[]
  tempo?: number
...
export interface MelodyParams extends ClipParams {
  ...
  keyContext?: import('@symphonyscript/core/theory/types').KeyContext
  /** 
   * Accidental override for the next note only.
   * Auto-clears after note() is called.
   */
  nextAccidental?: import('@symphonyscript/core/theory/types').Accidental
}
