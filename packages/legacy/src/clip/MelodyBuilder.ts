...
import { degreeToNote, SCALE_INTERVALS } from '@symphonyscript/core/scales'
...
import { createRandom, SeededRandom } from '@symphonyscript/core/util/random'
import { midiToNote, noteToMidi } from '@symphonyscript/core/util/midi'
import { parseDuration as parseDur } from '@symphonyscript/core/util/duration'
...
import { chordToNotes } from '@symphonyscript/core/chords/resolver'
import type { ChordCode, ChordOptions, ChordRoot } from '@symphonyscript/core/chords/types'
import { applyKeySignature } from '@symphonyscript/core/theory/keys'
import type { Accidental } from '@symphonyscript/core/theory/types'
...
export class MelodyBuilder<P extends MelodyParams = MelodyParams>
  ...
  progression(
    ...
    const { romanToChord } = require('@symphonyscript/core/theory/progressions')
  ...
  voiceLead(
    ...
    // Import modules
    const { romanToChord } = require('@symphonyscript/core/theory/progressions')
    const { voiceLeadChords } = require('@symphonyscript/core/theory/voiceleading')
    const { chordToNotes } = require('@symphonyscript/core/chords/resolver')
   ...
   */
  tempoEnvelope(keyframes: import('@symphonyscript/core/types/primitives').TempoKeyframe[]): this {
