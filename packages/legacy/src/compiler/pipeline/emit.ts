...
import type { EasingCurve, NoteName } from '@symphonyscript/core/types/primitives'
...
import { midiChannel, type MidiChannel, midiControl, midiValue } from '@symphonyscript/core/types/midi'
