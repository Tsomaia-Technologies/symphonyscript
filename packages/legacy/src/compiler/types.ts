...
import type {Articulation, InstrumentId, NoteName, TempoCurve, TimeSignatureString} from '@symphonyscript/core/types/primitives'
import type {ClipOperation} from '../clip/types'
import type {InstrumentConfig} from '@symphonyscript/core/instrument/Instrument'
...
export interface CompilerContext {
  ...
  dynamicsRegion?: {
    ...
    fromVelocity?: number
    toVelocity?: number
    curve?: import('@symphonyscript/core/types/primitives').EasingCurve
    points?: import('../clip/types').VelocityPoint[]
    resolvedPoints?: { normalizedTime: number; value: number; curve?: import('@symphonyscript/core/types/primitives').EasingCurve }[]
  }
  // Swing context
  swing?: number             // 0 = straight, 0.5 = triplet feel, 1 = full swing
  groove?: import('@symphonyscript/core/groove/types').GrooveTemplate
  ...
  activeTempoRamp?: {
    ...
    curve?: import('@symphonyscript/core/types/primitives').TempoCurve
  }
}
