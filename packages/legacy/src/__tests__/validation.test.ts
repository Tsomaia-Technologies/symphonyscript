...
import { Duration, isNoteName, noteName, Notes } from '@symphonyscript/core/types/primitives'
...
describe('Validation System', () => {
  ...
  describe('Type Safety', () => {
    ...
    describe('AutomationTarget', () => {
      ...
      const { Clip } = require('@symphonyscript/core')
    ...
    describe('InstrumentId', () => {
      const { instrumentId, isInstrumentId } = require('@symphonyscript/core/types/primitives')
    ...
    describe('Velocity Standardization', () => {
      const { midiVelocityToNormalized, normalizedToMidiVelocity } = require('@symphonyscript/core/types/primitives')
      const { validate, BuilderValidationError } = require('../validation/runtime')
